...
The Website project holds the main website of the FuguBSD organization, at
www.fugubsd.org. fuguweb(1) renders the site from `.fuguwebrc` and `web/`.
...
- A citation of a unit of a sibling repository is a prose token with the
  repository name in front, for example Tooling WFL-WEB. It is never a link, and
  it never names a plan.
...
| Code | Document           | Area             |
| ---- | ------------------ | ---------------- |
| SITE | [site.md](site.md) | The main website |
